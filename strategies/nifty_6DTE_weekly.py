...
tests 20 profit-target and stop-loss combinations. It assumes
one 65-unit lot, 0.5% adverse slippage on every fill, zero fees, no re-entry, and
uses only current or earlier option quotes. Select the Weekly dataset because it
contains the complete DTE 6 through DTE 0 lifecycle for the weekly expiry.
"""
...
STRATEGY_NAME = "NIFTY weekly 6-DTE hedged short straddle sweep"
